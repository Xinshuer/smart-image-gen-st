...
// v0.7.7 主动加软插画 tag：用户反映命名 anime 角色 (yuigahama yui 等) + 校服/旗袍组合
// 触发模型 prior 走平涂 cel-shaded（粉丝绘画风），单纯删 flat color tag 压不住。
// 加 (soft shading:1.3), (gradient lighting:1.2), (detailed shading:1.1), painterly 主动拉向软插画风。
const ANATOMY_QUALITY_POS_ANIME = '(solo:1.4), (1girl:1.4), (perfect anatomy:1.2), (detailed body:1.1), (pointed chin:1.2), beautiful face, slender curves, (natural breast shape:1.4), (balanced proportions:1.4), (proportionate breasts:1.3), aesthetic body, body harmony, breasts smaller than torso, (soft shading:1.3), (gradient lighting:1.2), (detailed shading:1.1), painterly, illustration, (volumetric lighting:1.1)';
// 紧致曲线修饰：(model figure:1.2) + (fit body:1.2) 防"赘肉/plus-size"倾向（仅写实模型用）。
// v0.7.6 加韩国/日本明星脸 + 健身网红身材：(korean idol face:1.3), (japanese model face:1.2), athletic, fit waist, flat stomach, defined waist, no belly fat
// 用户反馈写实生图仍有腰间赘肉，要"健美苗条女网红 + 韩日明星脸"
const ANATOMY_QUALITY_POS_REALISTIC = '(solo:1.4), (1girl:1.4), (perfect anatomy:1.2), (detailed body:1.1), (realistic proportions:1.1), correct anatomy, (pointed chin:1.2), beautiful face, (korean idol face:1.3), (japanese model face:1.2), (model figure:1.3), (fit body:1.3), (athletic body:1.2), (toned abs:1.2), (flat stomach:1.3), (defined waist:1.2), (slim waist:1.2), toned body, slender curves, (natural breast shape:1.2), (balanced proportions:1.2), aesthetic body, body harmony, fitness influencer';
...
// v0.7.5 拆双轨：anime 用 1.5 重压 + 加 oversized/gigantic-deformity，realistic 保留 1.3 轻压避免影响正常大胸。
// v0.7.7 anime 加反平涂 tag (flat color:1.5) (cel shading:1.3) (vector art:1.2) — 命名角色 + 校服 prior 把模型拉向粉丝绘画平涂风，必须强压。
const ANATOMY_QUALITY_NEG_ANIME = '(flat color:1.5), (cel shading:1.3), (vector art:1.2), (anime coloring:1.2), simple shading, (no shading:1.3), (bad anatomy:1.3), (deformed:1.2), (mutation:1.2), disfigured, extra limbs, missing limbs, fused fingers, distorted body, wrong anatomy, anatomy error, malformed, (bad hands:1.3), (bad fingers:1.3), (extra fingers:1.3), (missing fingers:1.3), fused fingers, mutated hands, malformed hands, (plus size:1.4), (chubby:1.4), (fat:1.4), (overweight:1.4), (obese:1.3), excess body fat, fupa, belly fat, bulky body, thick body, sagging belly, double chin, ugly face, asymmetric face, derpy face, (deformed breasts:1.5), (balloon breasts:1.5), (pillow breasts:1.5), (asymmetric breasts:1.3), (uneven breasts:1.3), (oversized breasts:1.4), (gigantic breasts deformity:1.4), distorted breasts, melted breasts, breast bigger than torso, breast warping, bag of sand breasts';
// v0.7.6 写实加强反赘肉：腰间赘肉 / love handles / muffin top / belly roll / flabby / soft belly 全压 1.4-1.5
const ANATOMY_QUALITY_NEG_REALISTIC = '(bad anatomy:1.3), (deformed:1.2), (mutation:1.2), disfigured, extra limbs, missing limbs, fused fingers, distorted body, wrong anatomy, anatomy error, malformed, (bad hands:1.3), (bad fingers:1.3), (extra fingers:1.3), (missing fingers:1.3), fused fingers, mutated hands, malformed hands, (plus size:1.5), (chubby:1.5), (fat:1.5), (overweight:1.5), (obese:1.4), (love handles:1.5), (muffin top:1.5), (belly roll:1.5), (flabby:1.4), (soft belly:1.4), (fat waist:1.5), (thick waist:1.4), (waist fat:1.5), excess body fat, fupa, belly fat, bulky body, thick body, sagging belly, double chin, ugly face, asymmetric face, derpy face, (deformed breasts:1.3), (balloon breasts:1.3), (pillow breasts:1.3), (asymmetric breasts:1.2), (uneven breasts:1.2), distorted breasts, melted breasts, oversized breasts deformity, breast warping, bag of sand breasts';
