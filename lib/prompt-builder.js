...
// tag，让画面回归"女主为主体，男方仅必要可见（手/腿/阴茎）"。
const MALE_BODY_SUPPRESS_NEG = '(male butt focus:1.4), (male ass focus:1.4), (male buttocks in foreground:1.4), (male back focus:1.3), (large male body:1.3), (hairy male butt:1.3), (male butt close-up:1.3), male torso dominant, full body male, big male body, male body covering female, male ass crack, hairy male legs in foreground';
