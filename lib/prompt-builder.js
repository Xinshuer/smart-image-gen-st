...
// 紧致曲线修饰：(model figure:1.2) + (fit body:1.2) + toned body 防"赘肉/plus-size"倾向；
// booru 训练集的"plump/skindentation/no thigh gap"等词关联 plus-size 图像，需用 toned/fit 对冲。
// 颜值修饰：idol face + glamorous 防"娃娃脸/普通脸"，提升整体颜值。
const ANATOMY_QUALITY_POS = '(solo:1.4), (1girl:1.4), (perfect anatomy:1.2), (detailed body:1.1), (realistic proportions:1.1), correct anatomy, (pointed chin:1.2), small face, oval face, anime face, beautiful detailed face, (model figure:1.2), (fit body:1.2), toned body, slender curves, hourglass figure, (idol face:1.1), beautiful face, glamorous, attractive';
