...
// ────────────────────────────────────────────────────────────────────────
// v0.11.6 LUSTIFY 专用"欧美网红脸"美貌增强
// 用户反馈：写实模型出的脸普通，要"很漂亮的欧美网红脸/glamour 模特感"。
// 选用作者认可的高视觉影响 tag (analog photo / glamour photography 已在 PREFIX) +
// 关键面部审美词，控制加权数 ≤4 防 CLIP 过载（作者警告 shizoprompting harms）。
const LUSTIFY_BEAUTY_BOOST = '(gorgeous face:1.3), (high cheekbones:1.2), (plump lips:1.2), (defined jawline:1.2), instagram model, glamour photography, supermodel face, flawless skin, perfect makeup, contoured face, full lips, sculpted face, magazine cover model, european beauty, runway model';
