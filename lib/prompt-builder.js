...
const ANATOMY_QUALITY_POS = '(perfect anatomy:1.2), (detailed body:1.1), (realistic proportions:1.1), correct anatomy, (solo:1.3)';
...
const ANTI_MULTI_CHAR_NEG = '(multiple girls:1.4), (multiple characters:1.4), (2girls:1.3), (3girls:1.3), (chibi:1.3), mini character, mini people, small character on side, picture-in-picture, character inset, character sheet, multiple views, side character';
