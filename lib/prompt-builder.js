...
export function buildReferencePromptFull({ sdPrompt = '', model = 'wai_anihentai' }) {
    ...
    if (isAnimeModel(m)) {
        ...
        // v0.11.21 加 ANTI_PATTERN_BLEED 防旗袍/印花衣服花纹印到皮肤
        negative = `${NEGATIVE_EMBEDDINGS_SDXL}, ${ANATOMY_QUALITY_NEG_ANIME}, ${CLOTHES_BODY_NEG}, ${ANTI_MULTI_CHAR_NEG}, ${ANTI_PATTERN_BLEED_NEG}, ${STRONG_SFW_NEGATIVE}, ${NEGATIVE[m]}`;
    } else {
