...
// 加 (proportionate breasts:1.3) + breasts smaller than torso（实测 v0.7.4 + L-cup 巨乳卡片仍出气球胸畸形）。
// 写实保持 1.2 不动（用户反映写实压太狠胸变小）。
const ANATOMY_QUALITY_POS_ANIME = '(solo:1.4), (1girl:1.4), (perfect anatomy:1.2), (detailed body:1.1), (pointed chin:1.2), beautiful face, slender curves, (natural breast shape:1.4), (balanced proportions:1.4), (proportionate breasts:1.3), aesthetic body, body harmony, breasts smaller than torso';
