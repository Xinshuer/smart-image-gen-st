...
// multiple views/front and back view/turnaround/multiple characters 1.5 各值，保证 anime 模型 OL 角色不出三视图。
// 其余无加权（chubby face/round face/mini people 等 prior 较弱）。
const ANTI_MULTI_CHAR_NEG = '(multiple girls:1.5), (multiple characters:1.5), (character sheet:1.5), (multiple views:1.5), (front and back view:1.5), (turnaround:1.4), (chibi:1.3), 2girls, 3girls, twins, split screen, two side by side, mirror image, duplicate, reference sheet, round face, chubby face, baby face, mini character, mini people, small character on side, picture-in-picture, character inset, side character';
