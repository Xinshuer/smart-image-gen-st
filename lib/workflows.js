...
export const workflowTemplates = {
    pony: {
        ...
        // v0.7.4 拔 PAG（v0.7.3 加入后用户反映画风变平涂/损失插画细节）
    ...
    wai_illustrious: {
        ...
        // v0.7.4 拔 PAG（v0.7.3 加入 scale=3.0 后实测画风变平涂、损失插画细节，与 FBCache 串联尤甚）
        ...
        "9": { "inputs": { "width": 1024, "height": 1360, "batch_size": 1 }, "class_type": "EmptyLatentImage" },
