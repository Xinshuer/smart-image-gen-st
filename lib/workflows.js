...
export const workflowTemplates = {
    ...
    // 文件名后缀 _ilV50 = Illustrious v5.0 版本，使用 Illustrious 配置（CFG 3-5 / Euler a / 20-40 steps）。
    // 作者推荐 Illustrious PREFIX:
    //   masterpiece, best quality, amazing quality, very aesthetic, high resolution,
    //   ultra-detailed, absurdres, scenery, photorealistic, depth of field, photorealistic details
    // 训练目标：亚洲人脸 photo-realistic，自然语言 + booru tag 都可。
    nova_asian_il: {
        "1": { "inputs": { "ckpt_name": "novaExanimeXL_ilV50.safetensors", "clip_skip": "2" }, "class_type": "CheckpointLoaderSimple" },
        "6": { "inputs": { "model": ["1", 0], "object_to_patch": "diffusion_model", "residual_diff_threshold": 0.15, "start": 0.2, "end": 0.8, "max_consecutive_cache_hits": 5 }, "class_type": "ApplyFBCacheOnModel" },
        "7": { "inputs": { "clip": ["1", 1], "text": "%prompt%" }, "class_type": "CLIPTextEncode" },
        "8": { "inputs": { "clip": ["1", 1], "text": "%negative_prompt%" }, "class_type": "CLIPTextEncode" },
        "9": { "inputs": { "width": 832, "height": 1216, "batch_size": 1 }, "class_type": "EmptyLatentImage" },
